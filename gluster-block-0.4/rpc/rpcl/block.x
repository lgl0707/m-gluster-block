...
struct blockModifyCliUserInfo {
        blockModifyCli mobj;
        char blk_username[128];
        char blk_passwd[128];
};
typedef struct blockModifyCliUserInfo blockModifyCliUserInfo;
...
program GLUSTER_BLOCK_CLI {
  version GLUSTER_BLOCK_CLI_VERS {
    ...
    blockResponse BLOCK_MODIFY_CLI(blockModifyCliUserInfo) = 5;
